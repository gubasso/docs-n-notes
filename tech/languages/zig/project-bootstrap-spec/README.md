...
1. Follow this [`runbook.md`](runbook.md) for the Zig-specific overlay steps.
...
- [`cli-project.md`](cli-project.md) — Zig CLI executable: the bootstrap-time ordering for argument
  parsing, the run/test steps, and a small command surface.
