...
- [§ Test-structure vocabulary](08-testing-strategy.md#test-structure-vocabulary)
- [§ DRY vs DAMP in tests](08-testing-strategy.md#dry-vs-damp-in-tests)
- [§ Detecting "testing the third-party library"](08-testing-strategy.md#detecting-testing-the-third-party-library)
- [§ Mutation testing as quality gate](08-testing-strategy.md#mutation-testing-as-quality-gate)
- [§ Property-based testing](08-testing-strategy.md#property-based-testing)
- [§ CI essentials](08-testing-strategy.md#ci-essentials)
