...
1. **Optional convenience** methods on the model (e.g., `ActiveProducts.save(path)`): if you keep them, make them **thin wrappers** that delegate to the adapter. This preserves the clean separation while remaining ergonomic.
