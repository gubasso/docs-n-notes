...
Notes and specs for Python development.

## Specs

- [`project-bootstrap-spec/`](project-bootstrap-spec/README.md) — the once-per-project Python
  bootstrap binding (toolchain, layout, quality gates, implementation kinds).
- [`release-workflow-spec/`](release-workflow-spec/README.md) — the Python release & publishing
  phase that follows bootstrap.
- [`cli-spec/`](cli-spec/README.md) — detailed Python CLI structure spec.
