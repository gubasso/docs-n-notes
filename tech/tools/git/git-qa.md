...
1. `git diff <starting_point>..<branch_name>`: This command then shows the difference between the starting point (where the branch started) and the current state of the branch.
...
1. **Checkout the file from the specific commit** :
